...
<div class="main-table-container-div" style="margin-top: 20px;">
    <div id="other-information" class="project-details-div" style="width: 100%; border: 1px solid #939393; border-radius: 6px; padding: 50px 55px 50px 55px; margin-bottom: 30px;">
        ...
        <!-- QUESTION 34_B -->
        <div style="display: grid; grid-template-columns: 1fr 1fr">
            <div style="border: 1px solid #939393; padding: 20px 30px 20px 30px; border-top: 0; width: 650px;">
            ...
            <div style="border: 1px solid #939393; padding: 20px 30px 20px 30px; border-left: 0px; border-top: 0;">
                <div style="display: flex;">
                    <label id="question_34b">-</label>
                </div>

                <div>
                    <label id="question_34b_detail">-</label>
                </div>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr">
            ...
            <div style="border: 1px solid #939393; padding: 20px 30px 20px 30px; border-left: 0px; border-top: 0;">
                <div style="display: flex;">
                    <div style="display: flex; align-items: center; margin-right: 20px;">
                        <label id="question_35b">-</label>
                    </div>
                </div>

                <div>
                    <label id="question_35b_detail">-</label>
                </div>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr">
            ...
            <div style="border: 1px solid #939393; padding: 20px 30px 20px 30px; border-left: 0px; border-top: 0;">
                <div style="display: flex;">
                    <div style="display: flex; align-items: center; margin-right: 20px;">
                        <label id="question_36a">-</label>
                    </div>
                </div>

                <div>
                    <label id="question_36a_detail">-</label>
                </div>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr">
            ...
            <div style="border: 1px solid #939393; padding: 20px 30px 20px 30px; border-left: 0px; border-top: 0;">
                <div style="display: flex;">
                    <div style="display: flex; align-items: center; margin-right: 20px;">
                        <label id="question_37a">-</label>
                    </div>
                </div>

                <div>
                    <label id="question_37a_detail">-</label>
                </div>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr">
            ...
            <div style="border: 1px solid #939393; padding: 20px 30px 20px 30px; border-left: 0px; border-top: 0;">
                <div style="display: flex;">
                    <div style="display: flex; align-items: center; margin-right: 20px;">
                        <label id="question_38a">-</label>
                    </div>
                </div>

                <div>
                    <label id="question_38a_detail">-</label>
                </div>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr">
            ...
            <div style="border: 1px solid #939393; padding: 20px 30px 20px 30px; border-left: 0px; border-top: 0;">
                <div style="display: flex;">
                    <div style="display: flex; align-items: center; margin-right: 20px;">
                        <label id="question_38b">-</label>
                    </div>
                </div>

                <div>
                    <label id="question_38b_detail">-</label>
                </div>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr">
            ...
            <div style="border: 1px solid #939393; padding: 20px 30px 20px 30px; border-left: 0px; border-top: 0;">
                <div style="display: flex;">
                    <div style="display: flex; align-items: center; margin-right: 20px;">
                        <label id="question_39a">-</label>
                    </div>
                </div>

                <div>
                    <label id="question_39a_detail">-</label>
                </div>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr">
            ...
            <div style="border: 1px solid #939393; padding: 20px 30px 20px 30px; border-left: 0px; border-top: 0;">
                <div style="display: flex;">
                    <div style="display: flex; align-items: center; margin-right: 20px;">
                        <label id="question_40a">-</label>
                    </div>
                </div>

                <div>
                    <label id="question_40a_detail">-</label>
                </div>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr">
            ...
            <div style="border: 1px solid #939393; padding: 20px 30px 20px 30px; border-left: 0px; border-top: 0;">
                <div style="display: flex;">
                    <div style="display: flex; align-items: center; margin-right: 20px;">
                        <label id="question_40b">-</label>
                    </div>
                </div>

                <div>
                    <label id="question_40b_detail">-</label>
                </div>
            </div>
        </div>
        <!-- QUESTION 40 C -->
        <div style="display: grid; grid-template-columns: 1fr 1fr">
            ...
            <div style="border: 1px solid #939393; padding: 20px 30px 20px 30px; border-left: 0px; border-top: 0;">
                <div style="display: flex;">
                    <div style="display: flex; align-items: center; margin-right: 20px;">
                        <label id="question_40c">-</label>
                    </div>
                </div>

                <div>
                    <label id="question_40c_detail">-</label>
                </div>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr 1FR">
            ...
            <div style="border: 1px solid #939393; padding: 20px 30px 20px 30px;">
                <div>
                    <label style="font-size: 13px; text-decoration: underline;">NAME</label>
                    <br/>
                    <label id="reference_name">-</label>
                </div>
            </div>
            ...
            <div style="border: 1px solid #939393; padding: 20px 30px 20px 30px; border-left: 0;">
                <div>
                    ...
                    <br/>
                    <label id="reference_address">-</label>
                </div>
            </div>
            ...
            <div style="border: 1px solid #939393; padding: 20px 30px 20px 30px; border-left: 0">
                <div>
                    ...
                    <br/>
                    <label id="reference_tel_no">-</label>
                </div>
            </div>
        </div>
        <!-- GOVERNMENT ISSUED -->
        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; margin-top: 20px">
            ...
            <div style="border: 1px solid #939393; padding: 20px 30px 20px 30px; border-left: 0">
                <div>
                    ...
                    <br/>
                    <label id="government_issued_appointment">-</label>
                </div>
            </div>
        </div>
    </div>
