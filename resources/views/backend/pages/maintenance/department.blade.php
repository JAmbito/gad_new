...
<section id="content">
    <main>
        ...
        <div class="add-user-container">
            <div class="add-btns btn-insert" style="margin-left: 10px">
                ...
                <button id="add_data">ADD DEPARTMENT</button>
            </div>
        ...
        <div style="margin-left: 30px;" class="selection-cont">
                <div class="table-pad">
                    <div class="table-header" id="header">
                        ...
                        <span id="teach-full-btn" style="margin-left: 0px; font-weight: 600; font-size: 14px;" class="proj-data">All Department</span>
    ...
    {{-- MODAL --}}
    <div id="department_modal" class="insert-cont" style="display: none;">
        ...
        <div class="header-fixed">
            ...
            <div class="insert-middle">
                    ...
                    <div>
                        <input type="text" id="department" name="department" placeholder="----" required="" autocomplete="off" style="margin-bottom: 23px;">
                    </div>
            </div>
...
@section('scripts')
    <script>
        ...
        function saveRecord() {
            ...
            $.post('/department/save', data).done(function(response){
                clearField();
        ...
        function deleteRecord() {
            $.get('/department/destroy/' + hold_id).done(function(response) {
                $('#confirmModal').hide();
                clearField();
                table.clear().draw();
            });
