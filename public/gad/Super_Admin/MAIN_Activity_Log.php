...
<head>
	...
	<link rel="stylesheet" type="text/css" href="CSS/DTM_1.css">	
		...
		<ul class="side-menu top"> 
			...
			<li class="active">
				...
				<ul id="bom-dropdown" style="margin-top: 10px">
						...
						<li class="emp-down-li emp-ac emp-paydas">
							<a href="MAIN_Activity_Log.php" class="act-hover">
								<h4 style="color: #D5D5D5; margin-right: 5px">—</h4>
								<span class="text active" >&nbsp;Activity Log</span>
	...
	<section id="content">
		...
		<main>
			...
			<div class="head-title" style="margin-bottom: 35px;">
				<div class="left">
					<h1 class="paragraph" style="letter-spacing: -.1px">Activity Log</h1>
					<div class="loc-date">
						<ul class="header-main">
							<li style="margin-top: 6px;">
								<i class="fi fi-rr-circle-user" style="color:#C30000; margin-left: 15px;"></i>
							</li>
							<li>
			...
			?>
				...
				<div class="add-user-container">
					...
					<div class="add-btns btn-insert" style="margin-left: 10px; display: none;">
						...
						<div class="table-header" id="header">
							...
							<span class="id-count-class">
								...
								<?php  
									...
									$sql = "SELECT `ID` FROM `activity_log` ORDER BY `ID`";
									$result=mysqli_query($con,$sql);
							...
							<span id="teach-full-btn" style="margin-left: 0px; font-weight: 600; font-size: 14px;" class="proj-data">All Activity-Logs</span>
					 ...
					 <table id="example" class="table table-striped" style="width:100%">
				        ...
				        <thead>
				            <tr>
				                ...
				                <th class="name-border" style="text-align: center!important;">Activity</th>
				                <th class="name-border" style="text-align: center!important;">Date</th>
				                <th class="name-border" style="text-align: center!important;">Time</th>
				            </tr>
				        </thead>
				        <tbody>
											...
											if($result){
												...
												echo
												 ...
												 '<tr>
														...
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase; min-width: 180px!important ">'.$name.'</td>
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase; min-width: 200px!important; text-align: center!important;">'.$activity.'</td>
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase; min-width: 100px!important; text-align: center!important;">'.date('M d, Y', strtotime($date)).'</td>
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase; min-width: 100px!important; text-align: center!important;">'.date('h:i A', strtotime($date)).'</td>
