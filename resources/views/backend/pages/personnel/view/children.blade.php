...
<table class="table" style="overflow-x: hidden; width: 100%; border: 1px solid #939393; border-radius: 6px; padding: 25px 30px 10px 30px; margin-bottom: 30px; text-transform: uppercase" id="family_children_table_id">
    <thead>
