...
if(isset($_POST['sub-insert'])){
	...
	// ADD CHILDREN
	$add_children_id = $_POST['add_children_id'];
	...
	$family_children_remove = $_POST['family_children_remove'];
    ...
    $educational_scholarship_class = $_POST["educational_scholarship"];
    $educational_remove = $_POST["educational_remove"];
	...
	$service_remove = $_POST['service_remove'];
	...
	$work_remove = $_POST['work_remove'];


	// IV VOLUNTARY WORK
	$voluntary_id = $_POST['voluntary_id'];
	...
	$voluntary_remove = $_POST['voluntary_remove'];
	...
	$learning_remove = $_POST['learning_remove'];
	...
	$hobbies_remove = $_POST['hobbies_remove'];

	// VIII OTHERS NON ACADEMIC
	$non_academic_id = $_POST['non_academic_id'];
	$others_non_academic = $_POST['others_non_academic'];
	$non_academic_remove = $_POST['non_academic_remove'];

	// VIII OTHERS MEMBERSHIP
	$membership_id = $_POST['membership_id'];
	$others_membership = $_POST['others_membership'];
	$membership_remove = $_POST['membership_remove'];
	...
	$gov_id_img = $_POST['gov_id_img'];
	$file_name = $_FILES['file']['name'];
    $file_tmp = $_FILES['file']['tmp_name'];
    $time = time();


    // I. PERSONAL INFO QUERY
    $sql = "UPDATE `main_i_personal_info`

	SET 

   `personal_surname` = '$personal_surname',
   `personal_firstname` = '$personal_firstname',
   `personal_name_extension` = '$personal_name_extension',
   `personal_middlename` = '$personal_middlename',
   `personal_birthday` = '$personal_birthday',
   `personal_bday_place` = '$personal_bday_place',
   `personal_designation` = '$personal_designation',
   `personal_department` = '$personal_department',
   `personal_academic_rank` = '$personal_academic_rank',
   `personal_administrative_rank` = '$personal_administrative_rank',
   `personal_emp_status` = '$personal_emp_status',
   `personal_campus` = '$personal_campus',
   `personal_sex` = '$personal_sex',
   `personal_civil_status` = '$personal_civil_status',
   `personal_height` = '$personal_height',
   `personal_weight` = '$personal_weight',
   `personal_blood` = '$personal_blood',
   `personal_gsis` = '$personal_gsis',
   `personal_pagibig` = '$personal_pagibig',
   `personal_philhealth` = '$personal_philhealth',
   `personal_sss` = '$personal_sss',
   `personal_tin` = '$personal_tin',
   `personal_id_no` = '$personal_id_no',
   `personal_citizenship` = '$personal_citizenship',
   `personal_by_birth` = '$personal_by_birth',
   `personal_dual_indication` = '$personal_dual_indication',
   `personal_residential_lot_no` = '$personal_residential_lot_no',
   `personal_residential_street` = '$personal_residential_street',
   `personal_residential_subdivision` = '$personal_residential_subdivision',
   `personal_residential_barangay` = '$personal_residential_barangay',
   `personal_residential_city` = '$personal_residential_city',
   `personal_residential_province` = '$personal_residential_province',
   `personal_residential_zipcode` = '$personal_residential_zipcode',
   `personal_permanent_lot_no` = '$personal_permanent_lot_no',
   `personal_permanent_street` = '$personal_permanent_street',
   `personal_permanent_subdivision` = '$personal_permanent_subdivision',
   `personal_permanent_barangay` = '$personal_permanent_barangay',
   `personal_permanent_city` = '$personal_permanent_city',
   `personal_permanent_province` = '$personal_permanent_province',
   `personal_permanent_zipcode` = '$personal_permanent_zipcode',
   `personal_tel_no` = '$personal_tel_no',
   `personal_mobile_no` = '$personal_mobile_no',
   `personal_email` = '$personal_email',
   `approval` = 'PENDING'

	WHERE `date_created` = '$datecreated_id';
	";
	$result = mysqli_query($con, $sql);  


	// II. FAMILY BACKFROUND
	$sql_1 = "UPDATE `main_ii_family_background` SET `family_spouse_surname`='$family_spouse_surname', `family_spouse_firstname`='$family_spouse_firstname', `family_spouse_name_extension`='$family_spouse_name_extension', `family_spouse_middlename`='$family_spouse_middlename', `family_spouse_occupation`='$family_spouse_occupation', `family_spouse_business_name`='$family_spouse_business_name', `family_spouse_business_address`='$family_spouse_business_address', `family_spouse_tel_no`='$family_spouse_tel_no', `family_father_surname`='$family_father_surname', `family_father_firstname`='$family_father_firstname', `family_father_name_extension`='$family_father_name_extension', `family_father_middlename`='$family_father_middlename', `family_mother_maiden_name`='$family_mother_maiden_name', `family_mother_surname`='$family_mother_surname', `family_mother_firstname`='$family_mother_firstname', `family_mother_name_extension`='$family_mother_name_extension', `family_mother_middlename`='$family_mother_middlename' WHERE `date_created` = '$datecreated_id'";
	...
	$for_add_children_id = $add_children_id[$index];
    ...
    $for_family_children_remove = $family_children_remove[$index];

    $sql_2 = "INSERT INTO `main_ii_add_children`(`ID`, `family_children_name`, `family_children_sex`, `family_children_bday`, `family_children_disability`, `date_created`) VALUES ('$for_add_children_id','$for_family_children_name','$for_family_children_sex','$for_family_children_bday','$for_family_children_disability','$datecreated_id')
    ON DUPLICATE KEY UPDATE `family_children_name`='$for_family_children_name', `family_children_sex`='$for_family_children_sex', `family_children_bday`='$for_family_children_bday', `family_children_disability`='$for_family_children_disability', `remove_status`= '$for_family_children_remove'";
	...
	$for_educational_id = $educational_id[$index];
    ...
    $for_educational_scholarship = $educational_scholarship_class[$index];
    $for_educational_remove = $educational_remove[$index];

    $sql_3 = "INSERT INTO `main_iii_educational_background`(`ID`, `educational_level`, `educational_school_name`, `educational_course`, `educational_attendance_from`, `educational_attendance_to`, `educational_units_earned`, `educational_year_graduated`, `educational_scholarship_class`, `date_created`) 
    VALUES ('$for_educational_id','$for_educational_level','$for_educational_school_name','$for_educational_course','$for_educational_attendance_from','$for_educational_attendance_to','$for_educational_units_earned','$for_educational_year_graduated','$for_educational_scholarship','$datecreated_id')

    ON DUPLICATE KEY UPDATE `educational_level`='$for_educational_level', `educational_school_name`='$for_educational_school_name', `educational_course`='$for_educational_course', `educational_attendance_from`='$for_educational_attendance_from', `educational_attendance_to`='$for_educational_attendance_to', `educational_units_earned`='$for_educational_units_earned', `educational_year_graduated`='$for_educational_year_graduated', `educational_scholarship_class`='$for_educational_scholarship', `remove_status`='$for_educational_remove'";
    $result_3 = mysqli_query($con, $sql_3);
	}


	// IV SERVICE BACKGROUND
	foreach($service_career as $index => $value){
	$for_service_id = $service_id[$index];
    ...
    $for_service_remove = $service_remove[$index];

    $sql_4 = "INSERT INTO `main_iv_service_eligibility`(`ID`, `service_career`, `service_rating`, `service_date_of_exam`, `service_place_of_exam`, `service_license`, `service_license_date`, `date_created`) 
    VALUES ('$for_service_id', '$for_service_career','$for_service_rating','$for_service_date_of_exam','$for_service_place_of_exam','$for_service_license','$for_service_license_date','$datecreated_id') 

    ON DUPLICATE KEY UPDATE `service_career`='$for_service_career', `service_rating` = '$for_service_rating', `service_date_of_exam` = '$for_service_date_of_exam', `service_place_of_exam` = '$for_service_place_of_exam', `service_license` = '$for_service_license', `service_license_date` = '$for_service_license_date', `remove_status`='$for_service_remove';";
    ...
    $for_work_remove = $work_remove[$index];

    $sql_5 = "INSERT INTO `main_v_work_experience`
            (`ID`, `work_inclusive_date_from`, `work_inclusive_date_to`, `work_position`, `work_agency`, `work_salary`, `work_pay_grade`, `work_appoinment`, `work_gov_service`, `date_created`)
            VALUES ('$for_work_id', '$for_work_inclusive_date_from', '$for_work_inclusive_date_to', '$for_work_position', '$for_work_agency', '$for_work_salary', '$for_work_pay_grade', '$for_work_appoinment', '$for_work_gov_service', '$datecreated_id')

            ON DUPLICATE KEY UPDATE 
            `work_inclusive_date_from`='$for_work_inclusive_date_from',
            `work_inclusive_date_to`='$for_work_inclusive_date_to',
            `work_position`='$for_work_position',
            `work_agency`='$for_work_agency',
            `work_salary`='$for_work_salary',
            `work_pay_grade`='$for_work_pay_grade',
            `work_appoinment`='$for_work_appoinment',
            `work_gov_service`='$for_work_gov_service',
            `remove_status`='$for_work_remove'";
	...
	$for_voluntary_id = $voluntary_id[$index];
    ...
    $for_voluntary_remove = $voluntary_remove[$index];

    $sql_6 = "INSERT INTO `main_vi_voluntary_work`(`ID`, `voluntary_name`, `voluntary_address`, `voluntary_date_from`, `voluntary_date_to`, `voluntary_no_of_hrs`, `voluntary_position`, `date_created`) 
        VALUES ('$for_voluntary_id', '$for_voluntary_name','$for_voluntary_address','$for_voluntary_date_from','$for_voluntary_date_to','$for_voluntary_no_of_hrs','$for_voluntary_position','$datecreated_id') 

        ON DUPLICATE KEY UPDATE `voluntary_name`='$for_voluntary_name', `voluntary_address` = '$for_voluntary_address', `voluntary_date_from` = '$for_voluntary_date_from', `voluntary_date_to` = '$for_voluntary_date_to', `voluntary_no_of_hrs` = '$for_voluntary_no_of_hrs', `voluntary_position` = '$for_voluntary_position', `remove_status`='$for_voluntary_remove';";
	...
	$for_learning_id = $learning_id[$index];
    ...
    $for_learning_remove = $learning_remove[$index];

    $sql_7 = "INSERT INTO `main_vii_learning_and_dev`(`ID`, `learning_training`, `learning_date_from`, `learning_date_to`, `learning_no_hrs`, `learning_ld_type`, `learning_sponsored`, `date_created`)
              VALUES ('$for_learning_id', '$for_learning_training','$for_learning_date_from','$for_learning_date_to','$for_learning_no_hrs','$for_learning_ld_type','$for_learning_sponsored','$datecreated_id')
              ON DUPLICATE KEY UPDATE
              `learning_training`='$for_learning_training', 
              `learning_date_from`='$for_learning_date_from',
              `learning_date_to`='$for_learning_date_to',
              `learning_no_hrs`='$for_learning_no_hrs',
              `learning_ld_type`='$for_learning_ld_type',
              `learning_sponsored`='$for_learning_sponsored',
              `remove_status`='$for_learning_remove';";
	...
	$for_hobbies_id = $hobbies_id[$index];
    $for_others_special_skills = $value;
    $for_hobbies_remove = $hobbies_remove[$index];

    $sql_8 = "INSERT INTO `main_viii_others_hobbies`(`ID`, `others_special_skills`, `date_created`)
        VALUES ('$for_hobbies_id', '$for_others_special_skills','$datecreated_id')

        ON DUPLICATE KEY UPDATE `others_special_skills`='$for_others_special_skills', `remove_status`='$for_hobbies_remove';";
	...
	$for_non_academic_id = $non_academic_id[$index];
    $for_others_non_academic = $value;
    $for_non_academic_remove = $non_academic_remove[$index];

    $sql_9 = "INSERT INTO `main_viii_others_non_academic`(`ID`, `others_non_academic`, `date_created`)
        VALUES ('$for_non_academic_id', '$for_others_non_academic','$datecreated_id')

        ON DUPLICATE KEY UPDATE `others_non_academic`='$for_others_non_academic', `remove_status`='$for_non_academic_remove';";
	...
	$for_membership_id = $membership_id[$index];
    $for_others_membership = $value;
    $for_membership_remove = $membership_remove[$index];

    $sql_10 = "INSERT INTO `main_viii_membership`(`ID`, `others_membership`, `date_created`)
        VALUES ('$for_membership_id', '$for_others_membership','$datecreated_id')
        ON DUPLICATE KEY UPDATE `others_membership`='$for_others_membership', `remove_status`='$for_membership_remove';";
	...
	// VIII QUESTIONS
	$sql_11 = "UPDATE `main_viii_others_questions` SET `q_34`='$q_34', `q_34_b`='$q_34_b', `q_35_a`='$q_35_a', `q_35_b`='$q_35_b', `q_36`='$q_36', `q_37`='$q_37', `q_38_a`='$q_38_a', `q_38_b`='$q_38_b', `q_39`='$q_39', `q_40_a`='$q_40_a', `q_40_b`='$q_40_b', `q_40_c`='$q_40_c' WHERE `date_created`='$datecreated_id'";
	...
	// VIII REFERENCE
	$sql_12 = "UPDATE `main_viii_others_reference` SET `reference_name`='$reference_name', `reference_address`='$reference_address', `reference_tel_no`='$reference_tel_no' WHERE `date_created`='$datecreated_id'";
	$result_12 = mysqli_query($con, $sql_12);




	// VIII ADD GOVERNMENT ISSUED
	$sql_13 = "UPDATE `main_viii_government_issued` SET `government_issued_id`='$government_issued_id', `government_issued_passport`='$government_issued_passport', `government_issued_date_issuance`='$government_issued_date_issuance', `government_issued_place_issuance`='$government_issued_place_issuance', `government_issued_img`='$gov_id_img', `government_issued_date_appointment`='$government_issued_date_appointment' WHERE `date_created`='$datecreated_id'";
	...
	header("location:DTM_Personnels_EDIT.php");
	...
	<head>
		...
		<title>GAD - Edit Personnel</title>
	</head>
	<body>
	...
	<!-- SIDE BAR END-->
			...
			<main>
				...
				<div class="table2-container" style="margin-top: 30px; padding-bottom: 5px;">
					...
					<div class="return-class">
			          <a href="DTM_Personnels_EDIT.php"><i class='bx bx-arrow-back'></i></a>
			        </div>
						...
						<div id="create-bom-cont-id" style="border: 0px solid #A2A2A2; border-radius: 6px; padding: 20px 30px 20px 30px; margin-bottom: -23px; margin-top: 10px;">
								...
								<div id="" class="project-details-div" style="width: 100%; border: 1px solid #939393; border-radius: 6px; padding: 50px 55px 20px 55px; margin-bottom: 30px;">
									...
									<div style="margin-bottom: 25px;">
                                     ...
                                     <div style="margin-bottom: 10px; border-top: 1px solid #939393; padding-top: 22px">
		                                ...
		                                FROM `main_ii_add_children` WHERE `date_created` = '$datecreated_id' AND `remove_status` != 'REMOVED'";
										$result=mysqli_query($con,$sql);
											...
											<tbody>
	                                           ...
	                                           '
												 <tr>
													...
													<td hidden>
														<input type="text" name="family_children_remove[]" placeholder="----" autocomplete="off" class="children_remove_input" value="" hidden>
													</td>
													<td class="remove_children_each" style="min-width: 30px!important; cursor: pointer;"><i class="fa-solid fa-minus" style="background-color: #FF7979; color: #fff; border-radius: 4px; padding: 13px 13.5px; font-size: 13px;"></i>
													</td>
												</tr>
												';
							...
							<div class="main-table-container-div" style="margin-top: 20px;">
								...
								<?php 
	                                ...
	                                FROM `main_iii_educational_background` WHERE `date_created` = '$datecreated_id' AND `remove_status` != 'REMOVED'";
									$result=mysqli_query($con,$sql);
									...
									<table class="table table-responsive-block" style="width: 100%; border: 1px solid #939393; border-radius: 6px; padding: 25px 30px 10px 30px; margin-bottom: 30px;" id="educational_table_id">
										...
										<tbody>
											...
											<tr>
												...
												<td hidden>
													<input type="text" name="educational_remove[]" placeholder="----" autocomplete="off" class="education_remove_input" value="" hidden>
												</td>
												<td class="remove_educational_each" style="min-width: 30px!important; cursor: pointer;"><i class="fa-solid fa-minus" style="background-color: #FF7979; color: #fff; border-radius: 4px; padding: 13px 13.5px; font-size: 13px;"></i>
												</td>
							...
							<div class="main-table-container-div" style="margin-top: 20px;">
								...
								<div id="" class="project-details-div" style="">
	                                ...
	                                FROM `main_iv_service_eligibility` WHERE `date_created` = '$datecreated_id' AND `remove_status` != 'REMOVED'";
									$result=mysqli_query($con,$sql);
                                    ...
                                    <table class="table table-responsive-block" style="width: 100%; border: 1px solid #939393; border-radius: 6px; padding: 25px 30px 10px 30px; margin-bottom: 30px;" id="service_table_id">
										...
										<tbody>
											...
											<tr>
												...
												<td hidden>
													<input type="text" name="service_remove[]" placeholder="----" autocomplete="off" class="service_remove_input" value="" hidden>
												</td>
												<td class="remove_service_each" style="min-width: 30px!important; cursor: pointer;"><i class="fa-solid fa-minus" style="background-color: #FF7979; color: #fff; border-radius: 4px; padding: 13px 13.5px; font-size: 13px;"></i>
												</td>
											</tr>';
							...
							<div class="main-table-container-div" style="margin-top: 20px;">
								...
								<div id="" class="project-details-div">
	                                ...
	                                FROM `main_v_work_experience` WHERE `date_created` = '$datecreated_id' AND `remove_status` != 'REMOVED'";
									$result=mysqli_query($con,$sql);
                                    ...
                                    <table class="table table-responsive-block" style="width: 100%; border: 1px solid #939393; border-radius: 6px; padding: 25px 30px 10px 30px; margin-bottom: 30px;" id="work_table_id">
										...
										<tbody>
											...
											<tr>
												...
												<td hidden>
													<input type="text" name="work_remove[]" placeholder="----" autocomplete="off" class="work_remove_input" value="" hidden>
												</td>
												<td class="remove_work_each" style="min-width: 30px!important; cursor: pointer;"><i class="fa-solid fa-minus" style="background-color: #FF7979; color: #fff; border-radius: 4px; padding: 13px 13.5px; font-size: 13px;"></i>
												</td>
											</tr>';
							...
							<div class="main-table-container-div" style="margin-top: 20px;">
								...
								<div id="" class="project-details-div">
	                                ...
	                                FROM `main_vi_voluntary_work` WHERE `date_created` = '$datecreated_id' AND `remove_status` != 'REMOVED'";
									$result=mysqli_query($con,$sql);
                                    ...
                                    <table class="table table-responsive-block" style="width: 100%; border: 1px solid #939393; border-radius: 6px; padding: 25px 30px 10px 30px; margin-bottom: 30px; position: relative;" id="voluntary_work_table_id">
										...
										<tbody>
											...
											<tr>
												...
												<td hidden>
													<input type="text" name="voluntary_remove[]" placeholder="----" autocomplete="off" class="voluntary_remove_input" value="" hidden>
												</td>
												<td class="remove_voluntary_each" style="min-width: 30px!important; cursor: pointer;"><i class="fa-solid fa-minus" style="background-color: #FF7979; color: #fff; border-radius: 4px; padding: 13px 13.5px; font-size: 13px;"></i>
												</td>
							...
							<div class="main-table-container-div" style="margin-top: 20px;">
								...
								<div id="" class="project-details-div">
	                                ...
	                                FROM `main_vii_learning_and_dev` WHERE `date_created` = '$datecreated_id'  AND `remove_status` != 'REMOVED'";
									$result=mysqli_query($con,$sql);
                                    ...
                                    <table class="table table-responsive-block" style="width: 100%; border: 1px solid #939393; border-radius: 6px; padding: 25px 30px 10px 30px; margin-bottom: 30px; position: relative;" id="learning_table_id">
										...
										<tbody>
											...
											<tr>
												...
												<td hidden>
													<input type="text" name="learning_remove[]" placeholder="----" autocomplete="off" class="learning_remove_input" value="" hidden>
												</td>
												<td class="remove_learning_each" style="min-width: 30px!important; cursor: pointer;"><i class="fa-solid fa-minus" style="background-color: #FF7979; color: #fff; border-radius: 4px; padding: 13px 13.5px; font-size: 13px;"></i>
												</td>
							...
							<div class="main-table-container-div" style="margin-top: 20px;">
								...
								<div id="" class="project-details-div" style="width: 100%; border: 1px solid #939393; border-radius: 6px; padding: 50px 55px 50px 55px; margin-bottom: 30px;">
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; grid-gap: 15px; padding-bottom: 30px; border-bottom: 1px solid #939393;">
		                                ...
		                                FROM `main_viii_others_hobbies` WHERE `date_created` = '$datecreated_id' AND `remove_status` != 'REMOVED'";
										$result=mysqli_query($con,$sql);
                                		...
                                		<div id="hobbies-container">
                                			...
                                			<?php
		                                     ...
		                                     echo 
		                                        ...
		                                        '
	                                    		<div style="margin-top: 5px; margin-bottom:-20px; display: flex; align-items: center;" class="hobbies_div">
	                                    			...
	                                    			<input type="text" name="hobbies_remove[]" placeholder="----" autocomplete="off" class="hobbies_remove_input" value="" hidden>

	                                    			<span class="remove-hobbies_each" style="cursor: pointer; margin-bottom: 10px; margin-left: 7px">
                                             ...
                                             <div id="add-hobbies" style="text-align: left; cursor: pointer; min-width: 30px!important; margin-top: 15px;"><i class="fa-solid fa-plus" style="background-color: #65B2FF; color: #fff; border-radius: 4px; padding: 12px 18px 12px 12px; font-size: 12px;">
		                                ...
		                                FROM `main_viii_others_non_academic` WHERE `date_created` = '$datecreated_id' AND `remove_status` != 'REMOVED'";
										$result=mysqli_query($con,$sql);
                                    	...
                                    	<div id="non-academic-container">
                                			...
                                			<?php
		                                     ...
		                                     echo 
		                                        ...
		                                        '
	                                    		<div style="margin-top: 5px; margin-bottom:-20px; display: flex; align-items: center;" class="non_academic_div">
	                                    			...
	                                    			<input type="text" name="non_academic_remove[]" placeholder="----" autocomplete="off" class="non_academic_remove_input" value="" hidden>

	                                    			<span class="remove-non_academic_each" style="cursor: pointer; margin-bottom: 10px; margin-left: 7px">
											        <i class="fa-solid fa-minus" style="background-color: #FF7979; color: #fff; border-radius: 4px; padding: 13px 13.5px; font-size: 13px;"></i>
											        </span>
                                             ...
                                             <div id="add-non-academic" style="text-align: left; cursor: pointer; min-width: 30px!important; margin-top: 15px;"><i class="fa-solid fa-plus" style="background-color: #65B2FF; color: #fff; border-radius: 4px; padding: 12px 18px 12px 12px; font-size: 12px;">
                                    			<span style="font-family: 'sora'; font-weight: 400; font-size: 11px" class="hobbies-span">&nbsp;&nbsp;ADD MORE</span></i>
                                    		</div>
		                                ...
		                                FROM `main_viii_membership` WHERE `date_created` = '$datecreated_id' AND `remove_status` != 'REMOVED'";
										$result=mysqli_query($con,$sql);
                                    	...
                                    	<div id="membership-container">
                                			...
                                			<?php
		                                     ...
		                                     echo 
		                                        ...
		                                        '
	                                    		<div style="margin-top: 5px; margin-bottom:-20px; display: flex; align-items: center;" class="membership_div">
	                                    			...
	                                    			<input type="text" name="membership_remove[]" placeholder="----" autocomplete="off" class="membership_remove_input" value="" hidden>

	                                    			<span class="remove-membership_each" style="cursor: pointer; margin-bottom: 10px; margin-left: 7px">
											        <i class="fa-solid fa-minus" style="background-color: #FF7979; color: #fff; border-radius: 4px; padding: 13px 13.5px; font-size: 13px;"></i>
											        </span>
                                             ...
                                             <div id="add-membership" style="text-align: left; cursor: pointer; min-width: 30px!important; margin-top: 15px;"><i class="fa-solid fa-plus" style="background-color: #65B2FF; color: #fff; border-radius: 4px; padding: 12px 18px 12px 12px; font-size: 12px;">
                                    			<span style="font-family: 'sora'; font-weight: 400; font-size: 11px" class="hobbies-span">&nbsp;&nbsp;ADD MORE</span></i>
                                    		</div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
			  $('input[type=radio][name=q_34_b_radio]').change(function() {
			    if (this.value == 'no') {
			      $('#q_34_b_id').val('');
			    }
			  });
		...
		<script type="text/javascript">
			$(document).ready(function() {
			  $('input[type=radio][name=q_35_a_radio]').change(function() {
			    if (this.value == 'no') {
			      $('#q_35_a_id').val('');
			    }
			  });
		...
		<script type="text/javascript">
			$(document).ready(function() {
			  $('input[type=radio][name=q_35_b_radio]').change(function() {
			    if (this.value == 'no') {
			      $('#q_35_b_id').val('');
			    }
			  });
		...
		<script type="text/javascript">
			$(document).ready(function() {
			  $('input[type=radio][name=q_36_radio]').change(function() {
			    if (this.value == 'no') {
			      $('#q_36_id').val('');
			    }
			  });
		...
		<script type="text/javascript">
			$(document).ready(function() {
			  $('input[type=radio][name=q_37_radio]').change(function() {
			    if (this.value == 'no') {
			      $('#q_37_id').val('');
			    }
			  });
		...
		<script type="text/javascript">
			$(document).ready(function() {
			  $('input[type=radio][name=q_38_a_radio]').change(function() {
			    if (this.value == 'no') {
			      $('#q_38_a_id').val('');
			    }
			  });
		...
		<script type="text/javascript">
			$(document).ready(function() {
			  $('input[type=radio][name=q_38_b_radio]').change(function() {
			    if (this.value == 'no') {
			      $('#q_38_b_id').val('');
			    }
			  });
		...
		<script type="text/javascript">
			$(document).ready(function() {
			  $('input[type=radio][name=q_39_radio]').change(function() {
			    if (this.value == 'no') {
			      $('#q_39_id').val('');
			    }
			  });
		...
		<script type="text/javascript">
			$(document).ready(function() {
			  $('input[type=radio][name=q_40_a_radio]').change(function() {
			    if (this.value == 'no') {
			      $('#q_40_a_id').val('');
			    }
			  });
		...
		<script type="text/javascript">
			$(document).ready(function() {
			  $('input[type=radio][name=q_40_c_radio]').change(function() {
			    if (this.value == 'no') {
			      $('#q_40_c_id').val('');
			    }
			  });
		...
		<script>
			...
			$(document).on('click', '.remove-membership_each', function() {
		     	$(this).parent().hide();
		        $(this).closest('.membership_div').find('.membership_remove_input').val("REMOVED");
		        return false;
		    });
		...
		<script type="text/javascript">
			...
			$(document).on('click', '.remove-non_academic_each', function() {
		     	$(this).parent().hide();
		        $(this).closest('.non_academic_div').find('.non_academic_remove_input').val("REMOVED");
		        return false;
		    });
		...
		<script>
			...
			$(document).on('click', '.remove-hobbies_each', function() {
		     	$(this).parent().hide();
		        $(this).closest('.hobbies_div').find('.hobbies_remove_input').val("REMOVED");
		        return false;
		    });
		...
		<script type="text/javascript">
			...
			$(document).on('click', '.remove_learning_each', function() {
		     	$(this).closest('tr').hide();
		        $(this).closest('tr').find('.learning_remove_input').val("REMOVED");
		        return false;
		    });
		...
		<script type="text/javascript">
			...
			$(document).on('click', '.remove_voluntary_each', function() {
		     	$(this).closest('tr').hide();
		        $(this).closest('tr').find('.voluntary_remove_input').val("REMOVED");
		        return false;
		    });
		...
		<script type="text/javascript">
			  ...
			  $(document).on('click', '.remove_work_each', function() {
			     	$(this).closest('tr').hide();
			        $(this).closest('tr').find('.work_remove_input').val("REMOVED");
			        return false;
			    });
		...
		<script type="text/javascript">
			...
			$("#add-service").click(function() {
			 ...
			 $(document).on('click', '.remove_service_each', function() {
			     	$(this).closest('tr').hide();
			        $(this).closest('tr').find('.service_remove_input').val("REMOVED");
			        return false;
			    });
		...
		<script type="text/javascript">
			...
			$(document).on('click', '.remove_educational_each', function() {
		     	$(this).closest('tr').hide();
		        $(this).closest('tr').find('.education_remove_input').val("REMOVED");
		        return false;
		    });
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
			    ...
			    $("#add-children").click(function() {
			     ...
			     $(document).on('click', '.remove_children_each', function() {
			     	$(this).closest('tr').hide();
			        $(this).closest('tr').find('.children_remove_input').val("REMOVED");
			        return false;
			    });
