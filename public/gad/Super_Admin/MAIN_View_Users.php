		...
		<ul class="side-menu top"> 
			...
			<li class="active">
				...
				<ul id="bom-dropdown" style="margin-top: 10px">
						<li class="emp-down-li emp-ac emp-paydas">
							<a href="MAIN_View_Users.php"  class="act-hover">
								<h4 style="color: #D5D5D5; margin-right: 5px">—</h4>
								<span class="text active">&nbsp;View Users</span>
	...
	<section id="content">
		...
		<main>
			...
			<div class="head-title" style="margin-bottom: 35px;">
				<div class="left">
					<h1 class="paragraph" style="letter-spacing: -.1px">Users</h1>
					<div class="loc-date">
			...
			<div style="margin-left: 30px;" class="selection-cont">
					<div class="table-pad">
						<div class="table-header" id="header">
							...
							<span id="teach-full-btn" style="margin-left: 0px; font-weight: 600; font-size: 14px;" class="proj-data">All Users</span>
					 ...
					 <table id="example" class="table table-striped" style="width:100%">
				        ...
				        <thead>
				            <tr>
				                ...
				                <th class="name-border">User Type</th>
				                <th class="name-border">Username</th>
											...
											if($result){
												...
												echo
												 ...
												 '<tr>
														...
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase;">'.$user_type.'</td>
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase;">'.$username.'</td>
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase;">'.$name.'</td>
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase;">'.$campus_name.'</td>
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase; text-align: center!important;"><span style="background: #7EF35C; padding: 5px 15px; color: #fff; border-radius: 50px;">ACTIVE</span></td>
