...
<body>
		...
		<ul class="side-menu top"> 
			...
			<li  class="active">
				...
				<ul id="dash-dropdown" style="margin-top: 10px">
					...
					<li class="emp-down-li emp-ac emp-paydas">
						<a href="DTM_Academic_Rank.php" class="act-hover">
							<h4 style="color: #D5D5D5; margin-right: 8px">—</h4>
							<span class="text active">&nbsp;Academic Rank</span>
		...
		<main>
			...
			<div id="emp_insert_modal" class="insert-cont" style="display: none;">
				<div class="insert-modal">
					<div class="header-fixed">
						<div class="insert-header" style="position: relative;">
						<h4>Create NEW Academic RANK</h4>
						<div><i class='bx bx-x' id="x-close-id"></i></div>
						</div>
					</div>
					<form action="DTM_Controls/DTM_Academic_Rank.php" method="POST" enctype="multipart/form-data">
			            ...
			            <div class="insert-middle">		
			             	 ...
			             	 <div>
								<input type="text" name="academic_rank" placeholder="----" required="" autocomplete="off" style="margin-bottom: 23px;">
							 </div>
						</div>
				...
				<div id="emp_delete_modal" class="delete-cont">
					<div class="delete-modal">
						...
						<form action="DTM_Controls/DTM_Academic_Rank.php" method="POST">
						...
						<div class="table-header" id="header">
							...
							<span class="id-count-class">
								...
								<?php  
									...
									$sql = "SELECT `ID` FROM `dtm_academic_rank` ORDER BY `ID`";
					 ...
					 <table id="example" class="table table-striped" style="width:100%">
				        ...
				        <thead>
				            <tr>
				                ...
				                <th class="name-border">Academic Rank</th>
				        ...
				        <tbody>
											...
											$sql="SELECT * FROM `dtm_academic_rank`";
											$result=mysqli_query($con,$sql);
											if($result){
													$no = 1;
	...
	<script>
	  ...
	  $('.btn-insert').click(function(){
          ...
          $.ajax({
               url:"DTM_Controls/DTM_Academic_Rank.php",
               method:"post",
