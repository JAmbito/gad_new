...
if(isset($_POST['sub-insert'])){
    ...
    $educational_scholarship_class = $_POST["educational_scholarship_class"];
    ...
    $time = time();
		...
		// PERSONAL INFO QUERY
		$sql = "INSERT INTO `main_i_personal_info`(`personal_surname`, `personal_firstname`, `personal_name_extension`, `personal_middlename`, `personal_birthday`, `personal_bday_place`, `personal_designation`, `personal_department`, `personal_academic_rank`, `personal_administrative_rank`, `personal_emp_status`, `personal_campus`, `personal_sex`, `personal_civil_status`, `personal_gsis`, `personal_pagibig`, `personal_philhealth`, `personal_sss`, `personal_tin`, `personal_id_no`, `personal_citizenship`, `personal_by_birth`, `personal_dual_indication`, `personal_residential_lot_no`, `personal_residential_street`, `personal_residential_subdivision`, `personal_residential_barangay`, `personal_residential_city`, `personal_residential_province`, `personal_residential_zipcode`, `personal_permanent_lot_no`, `personal_permanent_street`, `personal_permanent_subdivision`, `personal_permanent_barangay`, `personal_permanent_city`, `personal_permanent_province`, `personal_permanent_zipcode`, `personal_tel_no`, `personal_mobile_no`, `personal_email`, `date_created`)

	 	VALUES ('$personal_surname', '$personal_firstname', '$personal_name_extension', '$personal_middlename', '$personal_birthday', '$personal_bday_place', '$personal_designation', '$personal_department', '$personal_academic_rank', '$personal_administrative_rank', '$personal_emp_status', '$personal_campus', '$personal_sex', '$personal_civil_status', '$personal_gsis', '$personal_pagibig', '$personal_philhealth', '$personal_sss', '$personal_tin', '$personal_id_no', '$personal_citizenship', '$personal_by_birth', '$personal_dual_indication', '$personal_residential_lot_no', '$personal_residential_street', '$personal_residential_subdivision', '$personal_residential_barangay', '$personal_residential_city', '$personal_residential_province', '$personal_residential_zipcode', '$personal_permanent_lot_no', '$personal_permanent_street', '$personal_permanent_subdivision', '$personal_permanent_barangay', '$personal_permanent_city', '$personal_permanent_province', '$personal_permanent_zipcode', '$personal_tel_no', '$personal_mobile_no', '$personal_email', '$datecreatedexact')";
        ...
        foreach($educational_school_name as $index => $value){
	    	...
	    	$for_educational_scholarship_class = $educational_scholarship_class[$index];
	    	...
	    	VALUES ('$for_educational_level','$for_educational_school_name','$for_educational_course','$for_educational_attendance_from','$for_educational_attendance_to','$for_educational_units_earned','$for_educational_year_graduated','$for_educational_scholarship_class','$datecreatedexact');";
	...
	<head>
		...
		<title>GAD - View Personnel</title>
	</head>
	<body>
