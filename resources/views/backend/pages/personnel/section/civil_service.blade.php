    ...
    <div id="civil-service-eligibility" class="project-details-div" style="">
        ...
        <table class="table table-responsive-block" style="width: 100%; border: 1px solid #939393; border-radius: 6px; padding: 25px 30px 10px 30px; margin-bottom: 30px;" id="service_table_id">
            ...
            <tbody id="service_tbl">
                <tr>
                    <td>
                        <input type="hidden" name="service_career[]" class="service_id_class" placeholder="----" autocomplete="off" style="width: 350px">
                    ...
                    <td>
                        ...
                        <input type="date" name="service_license_date[]" class="service_license_date_class" placeholder="----" autocomplete="off" style="width: 180px">
                    </td>
                </tr>
            </tbody>
        <tfoot>
