...
<head>
	...
	<title>GAD - Management Type</title>
</head>
<body>
						...
						<ul id="release-warehouse-dropdown" >
							...
							<li class="emp-down-li emp-ac emp-paydas" style="height: 45px!important;">
								<a href="DTM_Designation_Mananage_Type.php">
									<h4 style="color: #D5D5D5; margin-right: 5px; margin-left: 25px">—</h4>
									<span class="text" style="letter-spacing: 0px; color: #fff">&nbsp;Management Type</span>
								</a>
							</li>
						</ul>
		...
		<main>
			...
			<div id="emp_insert_modal" class="insert-cont" style="display: none;">
				<div class="insert-modal">
					<div class="header-fixed">
						<div class="insert-header" style="position: relative;">
						<h4>Create NEW Management Type</h4>
						<div><i class='bx bx-x' id="x-close-id"></i></div>
						</div>
					</div>
					<form action="DTM_Controls/DTM_management_type.php" method="POST" enctype="multipart/form-data">
			            ...
			            <div class="insert-middle">		
			             	 ...
			             	 <div>
								<input type="text" name="management_type" placeholder="----" required="" autocomplete="off" style="margin-bottom: 23px;">
							 </div>
						</div>
				...
				<div id="emp_delete_modal" class="delete-cont">
					<div class="delete-modal">
						...
						<form action="DTM_Controls/DTM_management_type.php" method="POST">
			...
			<div class="head-title" style="margin-bottom: 35px;">
				<div class="left">
					<h1 class="paragraph" style="letter-spacing: -.1px">Management Type</h1>
					<div class="loc-date">
						...
						<div class="table-header" id="header">
							...
							<span class="id-count-class">
								...
								<?php  
									...
									$sql = "SELECT `ID` FROM `dtm_management_type` ORDER BY `ID`";
							...
							<span id="teach-full-btn" style="margin-left: 0px; font-weight: 600; font-size: 14px;" class="proj-data">All Management-Type</span>
											...
											if($result){
												...
												echo
												 ...
												 '<tr>
														...
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase;">'.$management_type.'</td>
	...
	<script>
	  ...
	  $('.btn-insert').click(function(){
          ...
          $.ajax({
               url:"DTM_Controls/DTM_management_type.php",
               method:"post",
