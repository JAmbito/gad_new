...
<body>
			...
			<li  class="active">
				...
				<ul id="dash-dropdown" style="margin-top: 10px">
					<li class="emp-down-li emp-ac emp-paydas">
						<a href="DTM_Campus.php" class="act-hover">
							<h4 style="color: #D5D5D5; margin-right: 8px">—</h4>
							<span class="text active">&nbsp;Campus</span>
		...
		<main>
			...
			<div id="emp_insert_modal" class="insert-cont" style="display: none;">
				<div class="insert-modal">
					...
					<form action="DTM_Controls/DTM_Campus.php" method="POST" enctype="multipart/form-data">
			            ...
			            <div class="insert-middle">
			            	 ...
			            	 <div>
			             	 ...
			             	 <div>
								<input type="file" name="file" style="margin-bottom: 23px; padding-top: 13px; background-color: #fff!important">
							 </div>
			             	 <div>
			             	 	<label>Campus Name</label><span class="additional-span">( REQUIRED )</span>
			             	 </div>
			             	 <div>
								<input type="text" name="campus_name" placeholder="----" required="" autocomplete="off" style="margin-bottom: 23px;">
							 </div>
							 ...
							 <div>
			             	 ...
			             	 <div>
								<input type="text" name="detailed_address" placeholder="----" required="" autocomplete="off" style="margin-bottom: 23px;">
							 </div>
							...
							<div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 15px;">
								...
								<div>
									<div>
				             	 	...
				             	 	<div>
										<input type="text" name="zip_code" placeholder="----" required="" autocomplete="off" style="margin-bottom: 23px;">
								 	</div>
							 	</div>
							</div>
							...
							<div>
								<div>
			             	 	...
			             	 	<div>
									<input type="email" name="email" placeholder="----" required="" autocomplete="off" style="margin-bottom: 23px;">
							 	</div>
						 	</div>
						 	...
						 	<div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 15px;">
							 	<div>
									<div>
				             	 	...
				             	 	<div>
										<input type="number" name="tel_no" placeholder="----" required="" autocomplete="off" style="margin-bottom: 23px;">
								 	</div>
							 	</div>
							 	...
							 	<div>
									<div>
				             	 	...
				             	 	<div>
										<input type="number" name="mobile_no" placeholder="----" required="" autocomplete="off" style="margin-bottom: 23px;">
								 	</div>
							 	</div>
						 	</div>
				...
				<div id="emp_delete_modal" class="delete-cont">
					<div class="delete-modal">
						...
						<form action="DTM_Controls/DTM_Campus.php" method="POST">
						...
						<div class="table-header" id="header">
							...
							<span class="id-count-class">
								...
								<?php
									...
									$sql = "SELECT `ID` FROM `dtm_campus` ORDER BY `ID`";
									$result=mysqli_query($con,$sql);
					 ...
					 <table id="example" class="table table-striped" style="width:100%">
				        ...
				        <thead>
				            <tr>
				            	...
				            	<th class="name-border" style="display: none;">Materials ID</th>
				                <th class="name-border">CAMPUS</th>
				                <th class="name-border">ACCESS</th>
				        ...
				        <tbody>
											...
											if($result){
													...
													while($row=mysqli_fetch_assoc($result)){
														...
														$campus_access=$row['campus_access'];

												echo

												 '<tr>
														<td style="text-align: left; font-size: 13px; width: 100px;">'.str_pad($no, "0", STR_PAD_LEFT).'</td>
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase; display: none;">'.$user_id.'</td>
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase;">'.$campus_name.'</td>
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase; min-width: 400px!important">'.$campus_access.'</td>
	...
	<script>
	  ...
	  $('.btn-insert').click(function(){
          ...
          $.ajax({
               url:"DTM_Controls/DTM_Campus.php",
               method:"post",
