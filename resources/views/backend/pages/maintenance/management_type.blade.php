...
<section id="content">
    <main>
        ...
        <div class="head-title" style="margin-bottom: 35px;">
            <div class="left">
                <h1 class="paragraph" style="letter-spacing: -.1px">Management <span style="font-size: 19px">/</span> Type</h1>
                <div class="loc-date">
        ...
        <div class="add-user-container">
            <div class="add-btns btn-insert" style="margin-left: 10px">
                ...
                <button id="add_data">ADD MANAGEMENT TYPE</button>
            </div>
        ...
        <div class="insert-modal">
            <div class="header-fixed">
                ...
                <div class="insert-middle">
                      ...
                      <div>
                        <input type="text" id="management_type" name="management_type" placeholder="----" required="" autocomplete="off" style="margin-bottom: 23px;">
                     </div>
                </div>
