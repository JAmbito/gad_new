    ...
    <script>
                    ...
                    if(work_info != null) {
                        ...
                        for (let index = 0; index < work_info.length; index++) {
                            var html = '<tr>' +
                                ...
                                '<input type="text" name="work_inclusive_date_from[]" value="'+ work_info[index].work_from +'" class="work_from_class" placeholder="----" autocomplete="off" style="width: 180px; margin-right: 10px">' +
                                '<input type="text" name="work_inclusive_date_to[]" value="'+ work_info[index].work_to +'" class="work_to_class" placeholder="----" autocomplete="off" style="width: 180px">' +
                                '</td>' +
                                '<td>' +
        ...
        function children() {
            $.each($('table#family_children_table_id tbody tr'), function(i,v) {
                children_data.push({
                    "children_id": $('.children_id_class')[i].value,
        ...
        function service() {
            $.each($('table#service_table_id tbody tr'), function(i,v) {
                service_data.push({
                    "service_id": $('.service_id_class')[i].value,
        ...
        function educational() {
            $.each($('table#educational_table_id tbody tr'), function(i,v) {
                educational_data.push({
                    "education_id": $('.education_id_class')[i].value,
        ...
        function voluntary() {
            $.each($('table#voluntary_work_table_id tbody tr'), function(i,v) {
                voluntary_data.push({
                    "voluntary_id": $('.voluntary_id_class')[i].value,
        ...
        function learning() {
            $.each($('table#learning_table_id tbody tr'), function(i,v) {
                learning_data.push({
                    "learning_id": $('.learning_id_class')[i].value,
        ...
        function hobby() {
            $.each($('table#hobby_table_id tbody tr'), function(i,v) {
                 hobby_data.push({
                    "hobby_id": $('.hobby_id_class')[i].value,
        ...
        function academic() {
            $.each($('table#academic_table_id tbody tr'), function(i,v) {
                 academic_data.push({
                    "academic_id": $('.academic_id_class')[i].value,
        ...
        function membership() {
            $.each($('table#membership_table_id tbody tr'), function(i,v) {
                 membership_data.push({
                    "membership_id": $('.membership_id_class')[i].value,
