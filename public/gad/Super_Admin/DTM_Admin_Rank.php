...
<head>
	...
	<title>GAD - Administrative Rank</title>
</head>
<body>
		...
		<ul class="side-menu top"> 
			...
			<li  class="active">
				...
				<ul id="dash-dropdown" style="margin-top: 10px">
					...
					<li class="emp-down-li emp-ac emp-paydas">
						<a href="DTM_Admin_Rank.php" class="act-hover">
							<h4 style="color: #D5D5D5; margin-right: 8px">—</h4>
							<span class="text active" >&nbsp;Administrative Rank</span>
		...
		<main>
			...
			<div id="emp_insert_modal" class="insert-cont" style="display: none;">
				<div class="insert-modal">
					...
					<form action="DTM_Controls/DTM_Administrative_Rank.php" method="POST" enctype="multipart/form-data">
			            ...
			            <div class="insert-middle">		
			             	 ...
			             	 <div>
								<input type="text" name="administrative_rank" placeholder="----" required="" autocomplete="off" style="margin-bottom: 23px;">
							 </div>
						</div>
				...
				<div id="emp_update_modal" class="update-cont" style="display: none;">
					<div class="update-modal">
						<div class="header-fixed">
							...
							<h4>UPDATE Administrative RANK</h4>
				...
				<div id="emp_delete_modal" class="delete-cont">
					<div class="delete-modal">
						...
						<form action="DTM_Controls/DTM_Administrative_Rank.php" method="POST">
						...
						<div class="table-header" id="header">
							...
							<span class="id-count-class">
								...
								<?php  
									...
									$sql = "SELECT `ID` FROM `dtm_administrative_rank` ORDER BY `ID`";
					 ...
					 <table id="example" class="table table-striped" style="width:100%">
				        ...
				        <thead>
				            <tr>
				                ...
				                <th class="name-border">Administrative Rank</th>
				        ...
				        <tbody>
											...
											$sql="SELECT * FROM `dtm_administrative_rank`";
											$result=mysqli_query($con,$sql);
											if($result){
													$no = 1;
												...
												echo
												 ...
												 '<tr>
														...
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase;">'.$administrative_rank.'</td>
	...
	<script>
	  ...
	  $('.btn-insert').click(function(){
          ...
          $.ajax({
               url:"DTM_Controls/DTM_Administrative_Rank.php",
               method:"post",
