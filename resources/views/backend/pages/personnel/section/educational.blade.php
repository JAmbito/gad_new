            ...
            <tbody id="educational_tbl">
                <tr>
                    <td>
                        ...
                        <select name="educational_level[]"  style="height: 38px; margin-bottom: 25px;" class="education_level_class">
                    ...
                    <td>
                        <input type="text" name="educational_attendance_from[]" placeholder="----" autocomplete="off" class="educational_from_class" style="width: 150px; margin-right: 10px;">
                        <input type="text" name="educational_attendance_to[]" placeholder="----" autocomplete="off" class="educational_to_class" style="width: 150px">
                    </td>
