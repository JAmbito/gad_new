...
<head>
	...
	<link rel="stylesheet" type="text/css" href="CSS/DTM_4.css">	
															...
															<div style="position: relative;">
																...
																<div style="" class="action-cont" id="action-cont-id">
																	<div style="text-align: left;">
																		<a href="DTM_Personnels_VIEW_DETAILS_APPROVAL.php?&datecreated_id='.$datecreated_id.'"><button data-id="1" class="btn-update">View Details</button></a>
																	</div>
																	<div style="text-align: left;">
																		<a href="DTM_Personnels_VIEW_APPROVAL.php?&datecreated_id='.$datecreated_id.'"><button data-id="1" class="btn-update">Approval</button></a>
																	</div>
																	<div style="text-align: left;">
