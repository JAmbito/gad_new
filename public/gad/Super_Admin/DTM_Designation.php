...
<head>
	...
	<link rel="stylesheet" type="text/css" href="CSS_SUBMENU/ADD_REMOVE_CLASS_RELEASE_WAREHOUSE_0.css">
	...
	<title>GAD - View Designation</title>
</head>
<body>
				...
				<ul id="dash-dropdown" style="margin-top: 10px">
					...
					<li class="emp-down-li emp-ac emp-paydas">
						<a href="#" class="release-warehouse-drop act-hover" style="position: relative;">
							...
							<span class="text active">&nbsp;Designation</span>
		...
		<main>
			...
			<div id="emp_insert_modal" class="insert-cont" style="display: none;">
				<div class="insert-modal">
					...
					<form action="DTM_Controls/DTM_designation.php" method="POST" enctype="multipart/form-data">
			            ...
			            <div class="insert-middle">		
			             	 ...
			             	 <div>
								<input type="text" name="designation" placeholder="----" required="" autocomplete="off" style="margin-bottom: 23px;">
							 </div>
				...
				<div id="emp_delete_modal" class="delete-cont">
					<div class="delete-modal">
						...
						<form action="DTM_Controls/DTM_designation.php" method="POST">
						...
						<div class="table-header" id="header">
							...
							<span class="id-count-class">
								...
								<?php  
									...
									$sql = "SELECT `ID` FROM `dtm_designation` ORDER BY `ID`";
									$result=mysqli_query($con,$sql);
							...
							<span id="teach-full-btn" style="margin-left: 0px; font-weight: 600; font-size: 14px;" class="proj-data">All Designation<span style="font-size: 10px">/</span>Position</span>
					 ...
					 <table id="example" class="table table-striped" style="width:100%">
				        ...
				        <thead>
				            <tr>
				                ...
				                <th class="name-border">DESIGNATION / POSITION</th>
				                <th class="name-border">Management Type</th>
				        ...
				        <tbody>
											...
											$sql="SELECT * FROM `dtm_designation`";
											$result=mysqli_query($con,$sql);
											if($result){
													$no = 1;
												...
												echo
												 ...
												 '<tr>
														...
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase;">'.$designation.'</td>
														<td class="name-border td-flex" style="text-align: left; white-space: nowrap; text-transform: uppercase; min-width: 400px!important">'.$management_type.'</td>
	...
	<script>
	  ...
	  $('.btn-insert').click(function(){
          ...
          $.ajax({
               url:"DTM_Controls/DTM_designation.php",
               method:"post",
