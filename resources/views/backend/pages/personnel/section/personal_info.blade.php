...
<div class="main-table-container-div">
    ...
    <div id="personal-info" class="project-details-div"
         style="width: 100%; border: 1px solid #939393; border-radius: 6px; padding: 50px 55px 20px 55px; margin-bottom: 30px;">
        ...
        <div style="margin-bottom: 40px">
            <span
                style="color: #fff; font-size: 12px!important; font-weight: 500; margin-left: 0px; background-color: #F5B041; border: 0px!important; padding: 5px 15px; border-radius: 25px; text-transform: uppercase;">NOTE : All required fields would be indicated with a label ( REQUIRED ).</span>
        </div>
        ...
        <div style="margin-bottom: 10px; border-top: 1px solid #939393; padding-top: 22px">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 15px;">
                <div>
                    ...
                    <input id="firstname" name="firstname" placeholder="----" required style="margin-bottom: 23px;"
                           value="">
                </div>
                <div>
            ...
            <div>
                <input id="middlename" name="middlename" placeholder="----" required style="margin-bottom: 23px;"
                       value="">
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 15px;">
                <div>
                    ...
                    <input type="date" id="birthday" name="birthday" placeholder="----" required
                           style="margin-bottom: 23px;" value="">
                </div>
                <div>
                    <label>Place Of Birth</label><span class="additional-span">( REQUIRED )</span>
                    <input id="birth_place" name="birth_place" placeholder="----" required style="margin-bottom: 23px;"
                           value="">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 15px;">
                <div>
                    ...
                    <input type="text" id="philhealth" name="philhealth" placeholder="----" style="margin-bottom: 23px;"
                           value="">
                </div>
                <div>
                    <label>SSS NO.</label>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr;">
                ...
                <div>
                    ...
                    <input id="dual_indication" name="dual_indication"
                           placeholder="If holder of dual citizenship, please indicate the details"
                           style="margin-bottom: 23px;" value="">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 15px;">
                <div>
                    <label for="personal_residential_lot_no_id">HOUSE/BLOCK/LOT NO.</label><span
                        class="additional-span">( REQUIRED )</span>
                    <input type="text" name="residential_lot_no" id="residential_lot_no" placeholder="----"
                           style="margin-bottom: 23px;" value="" required>
                </div>
                <div>
                    <label for="personal_residential_street_id">STREET</label><span
                        class="additional-span">( REQUIRED )</span>
                    <input name="residential_street" id="residential_street" placeholder="----"
                           style="margin-bottom: 23px;" value="" required>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 15px;">
                <div>
                    ...
                    <input type="text" name="residential_subdivision" id="residential_subdivision" placeholder="----"
                           style="margin-bottom: 23px;" value="" required>
                </div>
                <div>
                    <label for="personal_residential_barangay_id">BARANGAY</label><span class="additional-span">( REQUIRED )</span>
                    <input name="residential_barangay" id="residential_barangay" placeholder="----"
                           style="margin-bottom: 23px;" value="" required>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 15px;">
                <div>
                    ...
                    <input type="text" name="residential_city" id="residential_city" placeholder="----"
                           style="margin-bottom: 23px;" value="" required>
                </div>
                <div>
                    <label for="personal_residential_province_id">PROVINCE</label><span class="additional-span">( REQUIRED )</span>
                    <input name="residential_province" id="residential_province" placeholder="----"
                           style="margin-bottom: 23px;" value="" required>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr">
                <div>
                    ...
                    <input type="text" name="residential_zipcode" id="residential_zipcode" placeholder="----"
                           style="margin-bottom: 23px;" value="" required>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 15px;">
                <div>
                    ...
                    <input type="text" name="permanent_lot_no" id="permanent_lot_no" placeholder="----"
                           style="margin-bottom: 23px;" value="" required>
                </div>
                <div>
                    <label>STREET</label><span class="additional-span">( REQUIRED )</span>
                    <input name="permanent_street" id="permanent_street" placeholder="----" style="margin-bottom: 23px;"
                           value="" required>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 15px;">
                <div>
                    ...
                    <input type="text" name="permanent_subdivision" id="permanent_subdivision" placeholder="----"
                           style="margin-bottom: 23px;" value="" required>
                </div>
                <div>
                    <label>BARANGAY</label><span class="additional-span">( REQUIRED )</span>
                    <input name="permanent_barangay" id="permanent_barangay" placeholder="----"
                           style="margin-bottom: 23px;" value="" required>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 15px;">
                <div>
                    ...
                    <input type="text" name="permanent_city" id="permanent_city" placeholder="----"
                           style="margin-bottom: 23px;" value="" required>
                </div>
                <div>
                    <label>PROVINCE</label><span class="additional-span">( REQUIRED )</span>
                    <input name="permanent_province" id="permanent_province" placeholder="----"
                           style="margin-bottom: 23px;" value="" required>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr">
                <div>
                    ...
                    <input type="text" name="permanent_zipcode" id="permanent_zipcode" placeholder="----"
                           style="margin-bottom: 23px;" value="" required>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 15px;">
                ...
                <div>
                    ...
                    <input id="mobile_no" name="mobile_no" placeholder="----" required style="margin-bottom: 23px;"
                           value="">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr">
                <div>
                    ...
                    <input type="email" id="email" name="email" placeholder="----"
                           style="margin-bottom: 23px; text-transform: none;" value="" required>
                </div>
            </div>
        </div>
    </div>
