...
<head>
	...
	<title>GAD - Edit Personnels</title>
</head>
<body>
		...
		<ul class="side-menu top"> 
			...
			<li class="active">
				...
				<ul id="project-dropdown">
						...
						<li class="emp-down-li emp-ac emp-paydas">
							<a href="DTM_Personnels_EDIT.php" class="act-hover">
								<h4 style="color: #D5D5D5; margin-right: 5px">—</h4>
								<span class="text active" >&nbsp;Impending Edit</span>
			...
			<div id="emp_insert_modal" class="insert-cont" style="display: none;">
				...
				<div id="emp_delete_modal" class="delete-cont">
					<div class="delete-modal">
						...
						<form action="DTM_Controls/DTM_users.php" method="POST">
						...
						<div class="table-header" id="header">
							...
							<span class="id-count-class">
								...
								<?php  
									...
									$sql = "SELECT `ID` FROM `main_i_personal_info` WHERE `approval` = 'PENDING' ORDER BY `ID`";
									$result=mysqli_query($con,$sql);
					...
					<div class="table-pad">
					 ...
					 <table id="example" class="table table-striped" style="width:100%">
				        ...
				        <tbody>
											...
											$sql="SELECT * FROM `main_i_personal_info` WHERE `approval` = 'PENDING'";
											$result=mysqli_query($con,$sql);
											if($result){
													$no = 1;
												 ...
												 '<tr>
														...
														<td class="td-border-right" style="white-space: nowrap; border-right: none;">
															...
															<div style="position: relative;">
																...
																<a href="DTM_Personnels__IMPENDING_EDIT.php?&datecreated_id='.$datecreated_id.'">
																	<button data-id="1" class="btn-new-record hover_main" style="background-color:#B0BCCB; color: #fff; border-radius: 4px; height: 34px; padding-left: 20px; padding-right: 20px; letter-spacing: .3px; font-size: 12px; cursor: pointer; border: 0;">
																			EDIT
																	</button>
																</a>
	...
	$(document).ready(function(){
	 ...
	 $(document).on("click", '.btn-delete', function(){
          ...
          $.ajax({
               url:"DTM_Controls/DTM_users.php",
               method:"post",
